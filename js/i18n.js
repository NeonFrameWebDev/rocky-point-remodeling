...
(function () {
  ...
  function applyLang(lang) {
    ...
    // Update toggle button to show the OTHER language (the one you'd switch
    // to). Flag-and-label pattern: shows MX flag + Espanol when in English,
    // US flag + English when in Spanish.
    document.querySelectorAll(".lang-toggle").forEach((btn) => {
      btn.dataset.current = lang;
      const flag = btn.querySelector(".lt-flag");
